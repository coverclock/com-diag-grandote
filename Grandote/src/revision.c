...
#include "com/diag/grandote/revision.h"

const char COM_DIAG_GRANDOTE_REVISION_KEYWORD[] = "COM_DIAG_GRANDOTE_REVISION=" COM_DIAG_GRANDOTE_REVISION;
const char * COM_DIAG_GRANDOTE_REVISION_VALUE = &COM_DIAG_GRANDOTE_REVISION_KEYWORD[sizeof("COM_DIAG_GRANDOTE_REVISION=") - 1];
