...
/**
 *  Implements the Platform interface to the Diminuto library.
 *
 *  @author coverclock@diag.com (Chip Overclock)
 */
class Diminuto : public Platform {
...
public:
    ...
    /**
     *  Returns the frequency of the Diminuto clock in Hertz as a
    ...
    /**
     *  Returns the time of day in Diminuto ticks since the epoch.
     *
     *  @return the time of day in Diminuto ticks since the epoch.
     */
    ...
    /**
     *  Yields the processor at least the specified number of Diminuto ticks
     *  by delaying the calling thread.
     *
     *  @param  ticks       is the number of Diminuto ticks to yield.
     *
    ...
    /**
     *  Returns a reference to the Diminuto input functor.
     *
     *  @return a reference to the Diminuto input functor.
     */
    virtual Input& input();

    /**
     *  Returns a reference to the Diminuto output functor.
     *
     *  @return a reference to the Diminuto output functor.
     */
    virtual Output& output();

    /**
     *  Returns a reference to the Diminuto error output functor.
     *
     *  @return a reference to the Diminuto error output functor.
     */
    virtual Output& error();

    /**
     *  Returns a reference to the Diminuto log output functor.
     *  Data written to the log output functor go to the
     *  system log (syslog) with a priority of LOG_ERR.
     *
     *  @return a reference to the Diminuto log output functor.
     */
    virtual Output& log();

    /**
     *  Returns a reference to the Diminuto dump object. Output
     *  from this dump object will go to the Diminuto error output
     *  object.
     *
     *  @return a reference to the Diminuto dump object.
     */
    virtual Dump& dump();

    /**
     *  Returns a reference to the Diminuto heap object.
     *
     *  @return a reference to the Diminuto heap object.
     */
    virtual Heap& heap();

    /**
     *  Returns a reference to the Diminuto print object. Output
     *  from this print object will go to the Diminuto error output
     *  object.
     *
     *  @return a reference to the Diminuto print object.
     */
    virtual Print& print();

    /**
     *  Returns a reference to the Diminuto logger object. Output
     *  from this print object will go to the Diminuto log output
     *  object.
     *
     *  @return a reference to the Diminuto logger object.
     */
     ...
     *                  sent. If null (zero), the default Diminuto output
